    ...
    <>
      <div className=" tw-border-b">
        ...
        >
          ...
          <p className=" m-0 tw-text-black  tw-font-semibold tw-text-lg">{props.title}</p>
          {/* <p
        ...
        {props.isOpen && (
        <div className="  tw-text-black  tw-font-light tw-pb-4 sm:tw-text-[16px] tw-text-[13px]">{props.data}</div>
      )}
      </div>
